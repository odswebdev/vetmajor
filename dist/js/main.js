...
document.addEventListener("DOMContentLoaded", () => {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".center__swiper", {
    loop: false,
    slidesPerView: 1,
    spaceBetween: 50,
    pagination: {
  ...
  const swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".experts__swiper", {
    loop: false,
    slidesPerView: "auto",
    spaceBetween: 30,
    mousewheel: {
    ...
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Mousewheel]
  });
  ...
  function setTranslate(px) {
    let withTransition = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    slidesWrapper.style.transition = withTransition ? "transform 0.32s ease" : "none";
  ...
  function updateActiveClasses() {
    ...
    allKeys.forEach(key => {
      ...
      nodes.forEach(n => n.classList.toggle("active", Number(key) === currentIndex));
    });
  }
  ...
  function onPointerMove(e) {
    ...
    if (currentTranslate > maxTranslate + 100) currentTranslate = maxTranslate + 100;
    if (currentTranslate < minTranslate - 100) currentTranslate = minTranslate - 100;
